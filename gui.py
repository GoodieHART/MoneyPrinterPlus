...
with (llm_container):
    llm_providers = ['OpenRouter','OpenAI', 'Moonshot', 'Azure', 'Qianfan', 'Baichuan', 'Tongyi', 'DeepSeek', 'Ollama']
    ...
    with st.expander(llm_provider, expanded=True):
        ...
        if llm_provider == 'Qianfan':
            ...
            if llm_provider == 'Azure' or llm_provider == 'DeepSeek' or llm_provider == 'Ollama' or llm_provider == 'OpenRouter':
